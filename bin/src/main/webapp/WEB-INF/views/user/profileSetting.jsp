            ...
            <article class="setting__content">
                ...
                <form id="profile_update_form">
                    <div class="content-item__02">
                     <div class="item__title">아이디</div>
                        <div class="item__input">
                            <input type="text" name="username" placeholder="아이디" id="username" value="${principal.user.username}" readonly="readonly"/>
                        </div>
                    </div>
                    ...
                    <div class="content-item__04">
                        ...
                        <div class="item__input">
                            <input type="text" name="name" placeholder="사용자 이름" id="name" value="${principal.user.name}"/>
                        </div>
                    </div>
                    <div class="content-item__05">
                        <div class="item__title">웹사이트</div>
                        <div class="item__input">
                            <input type="text" name="website" placeholder="웹 사이트" id="website" value="${principal.user.website}" />
                        </div>
                    </div>
                    <div class="content-item__06">
                        <div class="item__title">소개</div>
                        <div class="item__input">
                            <textarea name="intro" id="bio" rows="3">${principal.user.bio}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="content-item__08">
                        ...
                        <div class="item__input">
                            <input type="text" name="email" placeholder="이메일" id="email" value="${principal.user.email}" readonly="readonly"/>
                        </div>
                    </div>
                    <div class="content-item__09">
                        <div class="item__title">전화번호</div>
                        <div class="item__input">
                            <input type="text" name="tel" placeholder="전화번호" id="phone" value="${principal.user.phone}" />
                        </div>
                    </div>
